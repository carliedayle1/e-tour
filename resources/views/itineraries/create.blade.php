                        ...
                        <form action="{{ route('attractions.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="description" name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write the description here...">{{ old('title') != null ? old('title'): '' }}</textarea>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="time" class="block mt-1 w-full" type="number" name="time" :value="old('time')" />
                                    <x-input-error :messages="$errors->get('time')" class="mt-2" />
                                </div>
                                <!-- Fee -->
                                <div>
                                    <x-input-label for="fee" :value="__('Fee')" />
                                    <x-text-input id="fee" class="block mt-1 w-full" type="number" name="fee" :value="old('fee')" />
