                                ...
                                <div>
                                    ...
                                    <div class="flex space-x-4 mt-2">
                                        <div>
                                            ...
                                            <x-text-input id="from_time" class="block mt-1 w-full" type="time" name="from_time" :value="old('from_time')" />
                                            <x-input-error :messages="$errors->get('from_time')" class="mt-2" />
                                        </div>
                                        <div>
                                            <x-input-label for="to_time" :value="__('To')" />
                                            <x-text-input id="to_time" class="block mt-1 w-full" type="time" name="to_time" :value="old('to_time')" />
