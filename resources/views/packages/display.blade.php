                    ...
                    <div>                       
                            <div class="grid gap-6 mb-6 mt-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="hours_days" readonly class="block mt-1 w-full" type="text" name="hours_days" :value="old('hours_days', $travel_package->timeslots()->latest()->first()->hours_days)" />
