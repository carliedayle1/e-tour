        ...
        <div class="relative pt-24 flex flex-col sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                ...
                <section>
                    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                        <div class="mr-auto place-self-center lg:col-span-7">
                            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Explore the world with ease, with E-Tour</h1>
                            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">"Embark on your next adventure with ease. Discover new destinations and experience the world like never before with E-Tour."</p>
                            <a href="/agency" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                                Become an Agent!
                        ...
                        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex" >
                            <img src="{{ asset('/images/summer_female.png') }}" alt="Summer Female" class="-mt-36">
                        </div>                
                    </div>
                </section>
            </div>
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="my-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                                @foreach($travel_packages as $travel_package)
                                    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <div class="p-5">
                                            <a href="/travel-packages/{{ $travel_package->id }}">
                                            ...
                                            <a href="/travel-packages/{{ $travel_package->id }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                Read more
                    ...
                    <div class="max-w-screen-md mb-8 lg:mb-16">
                        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Travel Packages</h2>
                        <p class="text-gray-500 sm:text-xl dark:text-gray-400">"No travel packages at the moment.."</p>
                    </div>
                    @endif
