...
<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('You selected the '. $plan->name . ' plan') }}
        </h2>
    </x-slot>
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                ...
                <div class="my-4">
                    <form action="{{ route('subscription.process') }}" method="POST" id="subscribe-form">
                        @csrf
                        <div class="mb-6">
                            <label for="card-holder" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Subscription Plan</label>
                            <input type="text" name="name" value="{{ $plan->name }}" id="amount" readonly  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <button type="button" id="card-button" data-secret="{{ $intent->client_secret }}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Process Payment</button>
                        </div>
